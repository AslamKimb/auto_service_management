...
## Summary
- 2135 nodes · 3277 edges · 372 communities (181 shown, 191 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 275 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `58921b48`
...
5. `_create_test_vehicle()` - 27 edges
6. `TestPhase6Contracts` - 27 edges
...
## Communities (372 total, 191 thin omitted)
...
Cohesion: 0.05
Nodes (33): RepairJobServiceConsumable, RepairJobServiceLabour, RepairJobServicePart, calculate_component_amount(), component_has_downstream(), _component_quantity(), _component_signature(), _copy_template_component_row() (+25 more)

### Community 2 - "Community 2"
Cohesion: 0.1
Nodes (46): sync_repair_job_related_tables(), _all_billable_components_submitted(), _assert_invoice_cancellation_allowed(), cancel_material_request(), cancel_sales_invoice(), _clear_component_link(), get_repair_job_sales_invoices(), has_active_repair_job_invoice() (+38 more)
...
Cohesion: 0.14
Nodes (13): _append_service_component(), _create_job_service(), _get_job_components(), _add_labour_line(), _add_parts_line(), _add_subcontract_line(), _create_repair_job(), _set_child_field() (+5 more)
...
Cohesion: 0.08
Nodes (23): Create an idempotent Service History snapshot., Create an idempotent Service History snapshot., Create an idempotent Service History snapshot., Create an immutable Repair Job Log entry., Issue a Gate Pass for this Repair Job., Update Customer Vehicle odometer and last service date on closure., Issue a Gate Pass for this Repair Job., Create an idempotent Service History snapshot. (+15 more)
...
Cohesion: 0.16
Nodes (3): _derive_repair_job_status(), _FakeDoc, TestWorkflowCompatibility
...
Cohesion: 0.15
Nodes (12): Return service/component rows for print formats and summaries., Return service/component rows for print formats and summaries., Return service/component rows for print formats and summaries., Return service/component rows for print formats and summaries., Return service/component rows for print formats and summaries., Return service/component rows for print formats and summaries., Return service/component rows for print formats and summaries., Return service/component rows for print formats and summaries. (+4 more)
...
Cohesion: 0.23
Nodes (11): _component_description(), _component_trace_fields(), create_material_request(), _eligible_components(), Create a Material Request for parts needed by this Repair Job.  	Tracks reques, Create a Material Request for approved Part and Consumable components., Save a mapped draft Material Request for compatibility callers., Save a mapped draft Material Request for compatibility callers. (+3 more)
...
Cohesion: 0.18
Nodes (4): IntegrationTestCase, TestQualityCheck, TestRepairJobOverride, TestRepairJobServiceTemplate
...
Cohesion: 0.25
Nodes (6): bump_repair_job_scope_revision(), invalidate_repair_job_authorizations(), recompute_repair_job_state(), approve(), reject(), execute()
...
Cohesion: 0.22
Nodes (9): create_sales_order(), Create a Sales Order from the linked Quotation.  	Returns the Sales Order name, Create a Sales Order from the linked Quotation., Create a Sales Order from the linked Quotation., Create a Sales Order from the linked Quotation., Create a Sales Order from the linked Quotation., Create a Sales Order from the linked Quotation., Create a Sales Order from the linked Quotation. (+1 more)
...
Cohesion: 0.29
Nodes (7): create_quotation(), Create a Quotation from approved service components., Create a Quotation from approved service components., Create a Quotation from approved service components., Create a Quotation from approved service components., Create a Quotation from approved service components., Create a Quotation from approved service components.
...
Cohesion: 0.5
Nodes (4): on_invoice_submit(), Update linked Repair Job when Sales Invoice is submitted., Update linked Repair Job when Sales Invoice is submitted., Update linked Repair Job when Sales Invoice is submitted.
...
## Knowledge Gaps
- **754 isolated node(s):** `Static Uganda-focused vehicle make/model starter catalog.`, `Set the ``app`` field on the Workspace if it is NULL.  	Required for Frappe v16`, `Set the ``type`` field on the Workspace if it is NULL.  	Required for Frappe v16`, `Keep the underlying workspace doc stable but expose a shorter label.`, `Remove obsolete app navigation even when Frappe left ``app`` blank.` (+749 more)
...
- **Why does `RepairJob` connect `Community 0` to `Community 5`, `Community 10`, `Community 11`, `Community 15`, `Community 16`, `Community 17`, `Community 50`, `Community 21`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `iter_repair_job_components()` connect `Community 1` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 37`, `Community 9`, `Community 58`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `TestPhase7HardeningIntegration` connect `Community 75` to `Community 8`, `Community 44`, `Community 38`, `Community 63`?**
