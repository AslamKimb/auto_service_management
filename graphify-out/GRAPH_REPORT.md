...
## Corpus Check
- 188 files · ~76,924 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1837 nodes · 2898 edges · 317 communities (151 shown, 166 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 250 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `801a4b63`
...
10. `_get_or_create_customer()` - 22 edges
...
## Communities (317 total, 166 thin omitted)
...
Cohesion: 0.11
Nodes (41): sync_repair_job_related_tables(), _all_billable_components_submitted(), _assert_invoice_cancellation_allowed(), cancel_material_request(), cancel_sales_invoice(), _clear_component_link(), get_repair_job_sales_invoices(), has_active_repair_job_invoice() (+33 more)
...
Cohesion: 0.1
Nodes (17): _create_test_vehicle(), _ensure_erpnext_basics(), _get_or_create_customer(), Create or reuse a test Customer Vehicle., Create or reuse a test Customer Vehicle., Create or reuse a test Customer Vehicle., Create or reuse a test Customer Vehicle., Create minimal ERPNext setup data if missing. (+9 more)
...
Cohesion: 0.12
Nodes (16): Auto Service Management Implementation Plan, Evidence Rules, Phase 0 — Repository Governance, Phase 10 — Repair Job State Authority Reconciliation, Phase 11 — Repair Job Component Billing and Single-Status Model, Phase 12 — Labour Service Items, Bay Warehouses, and Related-Table Consistency, Phase 13 — Workshop Operations, Release Policy, and Permissions, Phase 1 — Reproducible v16 Development (+8 more)
...
Cohesion: 0.17
Nodes (4): IntegrationTestCase, TestCustomerAuthorization, TestFleetServiceCampaign, TestWorkshopBay
...
## Knowledge Gaps
- **634 isolated node(s):** `Evidence Rules`, `Phase 0 — Repository Governance`, `Phase 1 — Reproducible v16 Development`, `Phase 2 — Domain and Control Foundation`, `Phase 3 — Intake and Workshop Operations` (+629 more)
...
- **Why does `RepairJob` connect `Community 0` to `Community 11`, `Community 15`, `Community 17`, `Community 51`, `Community 20`, `Community 25`, `Community 26`, `Community 29`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `iter_repair_job_components()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 7`, `Community 10`, `Community 42`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `RepairJobService` connect `Community 3` to `Community 1`, `Community 20`, `Community 12`, `Community 46`?**
