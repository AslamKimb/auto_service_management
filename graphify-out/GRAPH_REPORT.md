...
## Corpus Check
- 188 files · ~80,285 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1868 nodes · 2939 edges · 317 communities (155 shown, 162 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 251 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `26b53554`
...
7. `TestPhase6Contracts` - 25 edges
...
## Communities (317 total, 162 thin omitted)
...
Cohesion: 0.05
Nodes (39): _all_billable_components_submitted(), build_quality_check_road_test_row(), build_quality_check_road_test_rows(), build_repair_job_invoice_rows(), build_repair_job_payment_rows(), build_repair_job_service_rows(), build_repair_job_service_workshop_bay_rows(), bump_repair_job_scope_revision() (+31 more)
...
Cohesion: 0.08
Nodes (26): RepairJobServiceConsumable, RepairJobServiceLabour, RepairJobServicePart, calculate_component_amount(), component_has_downstream(), _component_quantity(), _component_signature(), _copy_template_component_row() (+18 more)
...
Cohesion: 0.06
Nodes (21): get_auto_service_settings_configured_card_data(), get_component_child_card_data(), get_repair_job_service_consumables_card_data(), get_repair_job_service_labour_card_data(), get_repair_job_service_parts_card_data(), get_repair_service_template_consumables_card_data(), get_repair_service_template_labour_card_data(), get_repair_service_template_parts_card_data() (+13 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (7): ServiceComponent, TestPhase10MappingUnits, _ServiceProbe, _TemplateProbe, TestPhase13TemplateMaterialization, TestPhase7HardeningContracts, UnitTestCase
...
Cohesion: 0.23
Nodes (10): _append_pending_labour_line(), _append_service_component(), _create_job_service(), _insert_authorization(), _insert_diagnosis(), _insert_quality_check(), _insert_road_test(), _insert_walkaround() (+2 more)
...
Cohesion: 0.11
Nodes (6): IntegrationTestCase, TestCustomerAuthorization, TestERPNextAdapters, TestFleetServiceCampaign, TestRepairJobOverride, TestWorkshopBay
...
## Knowledge Gaps
- **655 isolated node(s):** `Set the ``app`` field on the Workspace if it is NULL.  	Required for Frappe v16`, `Set the ``type`` field on the Workspace if it is NULL.  	Required for Frappe v16`, `Rebuild the app-owned Workspace Sidebar for the workshop workspace.  	Frappe v16`, `Expose Car Workshop as one directly routed Desk icon.  	Called from ``after_inst`, `Run all desktop setup steps: icon, workspace fields, sidebar.  	Called from ``af` (+650 more)
...
- **Why does `RepairJob` connect `Community 0` to `Community 5`, `Community 6`, `Community 16`, `Community 18`, `Community 19`, `Community 25`, `Community 26`, `Community 29`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `iter_repair_job_components()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 8`, `Community 10`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `TestPhase6Contracts` connect `Community 36` to `Community 99`, `Community 5`, `Community 6`, `Community 47`, `Community 15`, `Community 51`, `Community 52`?**
