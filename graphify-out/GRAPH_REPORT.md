# Graph Report - DMS  (2026-07-29)

## Corpus Check
- 200 files · ~91,131 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2030 nodes · 3147 edges · 340 communities (165 shown, 175 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 263 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `31504a44`
...
9. `Auto Service Management Implementation Plan` - 24 edges
10. `_create_repair_job()` - 23 edges
...
## Communities (340 total, 175 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.08
Nodes (47): approve_service_lines(), authorize(), cancel(), check_in(), close(), close_as_diagnosis_only(), complete_diagnosis(), complete_service_lines() (+39 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (31): RepairJobServiceConsumable, RepairJobServiceLabour, RepairJobServicePart, calculate_component_amount(), component_has_downstream(), _component_quantity(), _component_signature(), _copy_template_component_row() (+23 more)
...
Cohesion: 0.08
Nodes (42): get_auto_service_settings_configured_card_data(), get_component_child_card_data(), get_repair_job_service_consumables_card_data(), get_repair_job_service_labour_card_data(), get_repair_job_service_parts_card_data(), get_repair_service_template_consumables_card_data(), get_repair_service_template_labour_card_data(), get_repair_service_template_parts_card_data() (+34 more)
...
Cohesion: 0.07
Nodes (22): IntegrationTestCase, _create_test_vehicle(), _ensure_erpnext_basics(), _get_or_create_customer(), Create or reuse a test Customer Vehicle., Create or reuse a test Customer Vehicle., Create or reuse a test Customer Vehicle., Create or reuse a test Customer Vehicle. (+14 more)

### Community 8 - "Community 8"
Cohesion: 0.13
Nodes (12): _get_job_components(), _add_labour_line(), _add_parts_line(), _add_subcontract_line(), _create_repair_job(), _ensure_test_item(), _set_child_field(), _set_parent_field() (+4 more)
...
Cohesion: 0.18
Nodes (15): _append_pending_labour_line(), _insert_authorization(), _insert_diagnosis(), _insert_quality_check(), _insert_road_test(), _insert_walkaround(), Walk a Repair Job through the entire happy path., Walk a Repair Job through the entire happy path. (+7 more)
...
Cohesion: 0.08
Nodes (24): Auto Service Management Implementation Plan, Evidence Rules, Phase 0 — Repository Governance, Phase 10 — Repair Job State Authority Reconciliation, Phase 11 — Repair Job Component Billing and Single-Status Model, Phase 12 — Labour Service Items, Bay Warehouses, and Related-Table Consistency, Phase 13 — Workshop Operations, Release Policy, and Permissions, Phase 14 — Suite Integration: HRMS and Uganda Compliance (+16 more)
...
Cohesion: 0.22
Nodes (10): _build_sidebar_link(), _ensure_workspace_sidebar(), _get_workspace_sidebar_items(), Create the Workspace Sidebar entry if it does not exist.  	Frappe v16's desk loa, Rebuild the app-owned Workspace Sidebar for the workshop workspace.  	Frappe v16, Rebuild the app-owned Workspace Sidebar for the workshop workspace.  	Frappe v16, Rebuild the app-owned Workspace Sidebar for the workshop workspace.  	Frappe v16, Rebuild the app-owned Workspace Sidebar for the workshop workspace.  	Frappe v16 (+2 more)
...
Cohesion: 0.36
Nodes (3): _append_service_component(), _create_job_service(), TestDoubleBillingPrevention
...
Cohesion: 0.6
Nodes (5): all_doctypes(), _app_doctypes(), _ensure_full_system_manager_permission(), _ensure_standard_custom_permissions(), execute()
...
## Knowledge Gaps
- **711 isolated node(s):** `Static Uganda-focused vehicle make/model starter catalog.`, `Set the ``app`` field on the Workspace if it is NULL.  	Required for Frappe v16`, `Set the ``type`` field on the Workspace if it is NULL.  	Required for Frappe v16`, `Keep the underlying workspace doc stable but expose a shorter label.`, `Remove obsolete app navigation even when Frappe left ``app`` blank.` (+706 more)
...
- **Why does `iter_repair_job_components()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 8`, `Community 63`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `RepairJob` connect `Community 0` to `Community 11`, `Community 14`, `Community 15`, `Community 19`, `Community 51`, `Community 21`, `Community 22`, `Community 29`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `TestPhase6Contracts` connect `Community 33` to `Community 4`, `Community 109`, `Community 18`, `Community 50`, `Community 86`, `Community 58`, `Community 59`?**
