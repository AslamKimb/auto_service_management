# Graph Report - DMS  (2026-07-24)

## Corpus Check
- 193 files · ~86,879 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1950 nodes · 3051 edges · 332 communities (160 shown, 172 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 260 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fd80d965`
...
## Communities (332 total, 172 thin omitted)
...
Cohesion: 0.08
Nodes (27): RepairJobServiceConsumable, RepairJobServiceLabour, RepairJobServicePart, calculate_component_amount(), component_has_downstream(), _component_quantity(), _component_signature(), _copy_template_component_row() (+19 more)

### Community 4 - "Community 4"
Cohesion: 0.11
Nodes (42): recompute_repair_job_state(), sync_repair_job_related_tables(), approve(), reject(), _all_billable_components_submitted(), _assert_invoice_cancellation_allowed(), cancel_material_request(), cancel_sales_invoice() (+34 more)
...
Cohesion: 0.06
Nodes (42): 10. Workspace Fixture Must Include `type` Field, 11. Workspace Fixture Must Include `app` Field, 12. Workspace Sidebar Entry Required for Desk Navigation, 1. Stale Redis Cache â€” Module Map Empty, 2. Desktop Icon Must Use Workspace Sidebar, 3. Editable Install on Python 3.14, 4. Browser Cache After Server Fixes, 5. PowerShell Gotchas (+34 more)
...
Cohesion: 0.1
Nodes (19): hooks.py must declare add_to_apps_screen so Frappe creates an App-type Desktop I, hooks.py must declare add_to_apps_screen so Frappe creates an App-type Desktop I, desktop.py must exist and export create_app_desktop_icon and ensure_permission., desktop.py must exist and export create_app_desktop_icon and ensure_permission., hooks.py must declare add_to_apps_screen so Frappe creates an App-type Desktop I, hooks.py must declare add_to_apps_screen so Frappe creates an App-type Desktop I, desktop.py must exist and export create_app_desktop_icon and ensure_permission., desktop.py must exist and export create_app_desktop_icon and ensure_permission. (+11 more)
...
Cohesion: 0.1
Nodes (20): Auto Service Management Implementation Plan, Evidence Rules, Phase 0 — Repository Governance, Phase 10 — Repair Job State Authority Reconciliation, Phase 11 — Repair Job Component Billing and Single-Status Model, Phase 12 — Labour Service Items, Bay Warehouses, and Related-Table Consistency, Phase 13 — Workshop Operations, Release Policy, and Permissions, Phase 14 — Suite Integration: HRMS and Uganda Compliance (+12 more)
...
Cohesion: 0.11
Nodes (9): AutoServiceSettings, Document, FleetServiceCampaignJob, QualityCheckRoadTest, RepairJobInvoiceRow, RepairJobPaymentRow, RepairJobServiceRow, RepairServiceTemplatePart (+1 more)
...
Cohesion: 0.14
Nodes (5): IntegrationTestCase, TestERPNextAdapters, TestPhase7HardeningIntegration, TestRepairJobOverride, TestWorkshopBay
...
Cohesion: 0.17
Nodes (11): Run all desktop setup steps: icon, workspace fields, sidebar.  	Called from ``af, Run all desktop setup steps: icon, workspace fields, sidebar.  	Called from ``af, Run all desktop setup steps: icon, workspace fields, sidebar.  	Called from ``af, Run all desktop setup steps: icon, workspace fields, sidebar.  	Called from ``af, Run all desktop setup steps: icon, workspace fields, sidebar.  	Called from ``af, Run all desktop setup steps: icon, workspace fields, sidebar.  	Called from ``af, Run all desktop setup steps: icon, workspace fields, sidebar.  	Called from ``af, Run all desktop setup steps: icon, workspace fields, sidebar.  	Called from ``af (+3 more)
...
Cohesion: 0.25
Nodes (7): code:powershell (docker build --pull=false --progress=plain --tag aslamkimb/f), code:dotenv (DB_ROOT_PASSWORD=<new-unique-password>), code:bash (bench --site <dms-domain> list-apps), DMS Dokploy deployment, Dokploy configuration, Manual image build gate, Verification
...
Cohesion: 0.29
Nodes (7): _ensure_workspace_sidebar(), Create the Workspace Sidebar entry if it does not exist.  	Frappe v16's desk loa, Rebuild the app-owned Workspace Sidebar for the workshop workspace.  	Frappe v16, Rebuild the app-owned Workspace Sidebar for the workshop workspace.  	Frappe v16, Rebuild the app-owned Workspace Sidebar for the workshop workspace.  	Frappe v16, Rebuild the app-owned Workspace Sidebar for the workshop workspace.  	Frappe v16, Rebuild the app-owned Workspace Sidebar for the workshop workspace.  	Frappe v16
...
- **Why does `RepairJob` connect `Community 0` to `Community 34`, `Community 5`, `Community 14`, `Community 17`, `Community 19`, `Community 20`, `Community 28`, `Community 31`?**
  _High betweenness centrality (0.120) - this node is a cross-community bridge._
- **Why does `iter_repair_job_components()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 8`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `TestPhase7HardeningIntegration` connect `Community 44` to `Community 38`, `Community 10`, `Community 42`, `Community 12`, `Community 52`?**
